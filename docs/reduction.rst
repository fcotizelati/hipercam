...
There is also an experimental command, |epsfphot|, for workflows that need an
empirical PSF rather than the analytic Gaussian or Moffat models used by
|reduce|. It has subcommands to build an ePSF from isolated stars in an
